-- Zero Admin 核心数据库初始化
-- 仅用于空 PostgreSQL 数据库；已有数据库请使用 config/migrations/。
-- 包含系统核心表、主租户 000000、系统菜单、角色、字典、参数和 PC 客户端。
-- App 业务表与示例租户数据由同目录下的独立脚本负责。
...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100, '000000', 0,   '0',          '华南理工大学',   null,0, null, '15888888888', 'xxx@qq.com', '0', '0', 103, 1, now(), null, null);
insert into sys_dept values(101, '000000', 100, '0,100',      '深圳研究院', null,1, null, '15888888888', 'xxx@qq.com', '0', '0', 103, 1, now(), null, null);
insert into sys_dept values(102, '000000', 100, '0,100',      '继续教育学院', null,2, null, '15888888888', 'xxx@qq.com', '0', '0', 103, 1, now(), null, null);
...
insert into sys_menu values('2', '系统监控', '0', '4', 'monitor',          null, '', '1', '0', 'M', '0', '0', '', 'ze-monitor', 103, 1, now(), null, null, '系统监控目录');
...
-- 三级菜单
insert into sys_menu values('500',  '操作日志', '108', '1', 'operlog',    'system/log/operlog/index',    '', '1', '0', 'C', '0', '0', 'monitor:operlog:list',    'form',          103, 1, now(), null, null, '操作日志菜单');
insert into sys_menu values('501',  '登录日志', '108', '2', 'logininfor', 'system/log/logininfor/index', '', '1', '0', 'C', '0', '0', 'monitor:logininfor:list', 'logininfor',    103, 1, now(), null, null, '登录日志菜单');
-- 用户管理按钮
...
insert into sys_menu values('121', '租户管理', '6', '1', 'tenant', 'tenant/tenant', '', '1', '0', 'C', '0', '0', 'system:tenant:list', 'list', 103, 1, now(), null, null, '租户管理菜单');
insert into sys_menu values('122', '租户套餐管理', '6', '2', 'tenantPackage', 'tenant/tenantPackage/index', '', '1', '0', 'C', '0', '0', 'system:tenantPackage:list', 'form', 103, 1, now(), null, null, '租户套餐管理菜单');
...
insert into sys_tenant values(
    1, '000000', '管理组', '15888888888', '华南理工大学继续教育学院',
    null, null, '华南理工大学集团多分校租户通用后台管理系统',
    null, null, null, null, -1, '0', '0', 103, 1, now(), null, null
);
